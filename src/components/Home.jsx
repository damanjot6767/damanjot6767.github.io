...
const Home=()=>{
    ...
    //                 React, JavaScript, Node JS and Redux.
    //              </p>
    //              <div>
    ...
    //         </div>
    //         <div>
    //             <img src="https://avatars.githubusercontent.com/u/107990859?v=4" alt="my-picture" className="rounded-2xl mx-auto w-2/3 md:w-full"/>
    //         </div>
    //     </div>
    // </div>
    return(
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        ...
        <div>
          <img
            src="https://avatars.githubusercontent.com/u/107990859?v=4"
            alt="my profile"
